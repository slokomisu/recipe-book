  ...
  createJSON: function (answers) {
    ...
    if (answers.dist) {
      ...
      json.paths.output = {
        ...
        uncompressed: path.normalize(answers.dist + '/shared/'),
        compressed: path.normalize(answers.dist + '/shared/'),
  ...
  questions: {
    ...
    setup: [
      ...
      },
      {
        ...
        choices: [
          {
            name: 'Automatic (Use defaults locations and all shared)',
            value: 'auto'
          },
          {
            name: 'Express (Set shared and output folder)',
            value: 'express'
          },
          {
      ...
      },
      {
        type: 'checkbox',
        name: 'components',
        message: 'What shared should we include in the package?',
      ...
      },
      {
        type: 'input',
        name: 'compressed',
        message: 'Where should we output compressed shared?',
      ...
      },
      {
        type: 'input',
        name: 'uncompressed',
        message: 'Where should we output uncompressed shared?',
